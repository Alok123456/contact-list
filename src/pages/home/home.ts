...
export class HomePage {
  ...
  constructor(private everybody: Contacts,private loadingController: LoadingController,private toastController: ToastController,private contactsProvider: ContactsProvider,public navCtrl: NavController) {
  ...
  ionViewDidLoad() {
    ...
    this.contactList = this.everybody.find(["*"]);
